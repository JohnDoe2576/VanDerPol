...
UserSays.ReadNumber = 72;
UserSays.SaveNumber = 72;
...
UserSays.SimulateControllerCoupledToActualPlant = true;
UserSays.SaveUltimateSimulationData = false;
...
if UserSays.SimulateControllerCoupledToActualPlant == true
        % Initialize system
        ...
        % Uniformly-spaced different initial phases at which controller is
        % switched ON
        ...
        if UserSays.SaveUltimateSimulationData == true
                save('DataStore\VDP_NNPerf.mat','DatCP','Tctrl');
        end
end
